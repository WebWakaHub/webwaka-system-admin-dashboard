...
export interface IInstrumentationProbeObservability {
...
export class DefaultInstrumentationProbeObservability implements IInstrumentationProbeObservability {
