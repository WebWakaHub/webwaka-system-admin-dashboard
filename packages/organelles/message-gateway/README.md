# MessageGateway Organelle

**Organelle ID:** ORG-CI-MESSAGE_GATEWAY-v0.1.0
**Version:** 0.1.0
**Layer:** Organelle (smallest functional unit in WebWaka biological hierarchy)

## Overview

The MessageGateway organelle provides a self-contained, deterministic functional unit
...
```
┌─────────────────────────────────────────┐
│         MessageGatewayOrchestrator                 │
│                                         │
│  ┌──────────┐  ┌──────────────────────┐ │
│  │  State    │  │  MessageGatewayEntity          │ │
...
const orchestrator = new MessageGatewayOrchestrator({
  id: "my-message-gateway",
  name: "My MessageGateway",
  maxConcurrency: 5,
  timeoutMs: 30000,
