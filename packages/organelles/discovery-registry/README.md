# DiscoveryRegistry Organelle

**Organelle ID:** ORG-OD-DISCOVERY_REGISTRY-v0.1.0
**Version:** 0.1.0
**Layer:** Organelle (smallest functional unit in WebWaka biological hierarchy)

## Overview

The DiscoveryRegistry organelle provides a self-contained, deterministic functional unit
...
```
┌─────────────────────────────────────────┐
│         DiscoveryRegistryOrchestrator                 │
│                                         │
│  ┌──────────┐  ┌──────────────────────┐ │
│  │  State    │  │  DiscoveryRegistryEntity          │ │
...
const orchestrator = new DiscoveryRegistryOrchestrator({
  id: "my-discovery-registry",
  name: "My DiscoveryRegistry",
  maxConcurrency: 5,
  timeoutMs: 30000,
