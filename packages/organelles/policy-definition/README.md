# PolicyDefinition Organelle

**Organelle ID:** ORG-CP-POLICY_DEFINITION-v0.1.0
**Version:** 0.1.0
**Layer:** Organelle (smallest functional unit in WebWaka biological hierarchy)

## Overview

The PolicyDefinition organelle provides a self-contained, deterministic functional unit
...
```
┌─────────────────────────────────────────┐
│         PolicyDefinitionOrchestrator                 │
│                                         │
│  ┌──────────┐  ┌──────────────────────┐ │
│  │  State    │  │  PolicyDefinitionEntity          │ │
...
const orchestrator = new PolicyDefinitionOrchestrator({
  id: "my-policy-definition",
  name: "My PolicyDefinition",
  maxConcurrency: 5,
  timeoutMs: 30000,
