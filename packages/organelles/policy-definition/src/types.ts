/**
 * PolicyDefinition — Core Type Definitions
 * Organelle: ORG-CP-POLICY_DEFINITION-v0.1.0
 */

export enum PolicyDefinitionState {
  IDLE = "IDLE",
...
export interface PolicyDefinitionCommand {
...
export interface PolicyDefinitionQuery {
  readonly type: string;
  readonly filters?: Record<string, unknown>;
}

export interface PolicyDefinitionQueryResult {
  readonly data: Record<string, unknown>;
  readonly timestamp: number;
}

export interface PolicyDefinitionEvent {
  readonly type: string;
...
export interface PolicyDefinitionError {
