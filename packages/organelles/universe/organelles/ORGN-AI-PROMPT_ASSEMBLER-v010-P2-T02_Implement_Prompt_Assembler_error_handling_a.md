# [ORGN-AI-PROMPT_ASSEMBLER-v0.1.0-P2-T02] Implement Prompt Assembler error handling and fallback behaviour

**Structure:** `[ORGN-AI-PROMPT_ASSEMBLER-v0.1.0-P2-T02]`
**Layer:** Organelle
**Issue:** #940
...
The implementation of this issue satisfies all constitutional requirements for the `[ORGN-AI-PROMPT_ASSEMBLER-v0.1.0-P2-T02]` structure at the Organelle layer. All invariants defined in the issue body have been verified and encoded into the artefact record.
