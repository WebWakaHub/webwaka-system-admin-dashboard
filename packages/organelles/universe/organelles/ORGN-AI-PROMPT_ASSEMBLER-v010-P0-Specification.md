# Prompt Assembler — P0 Specification
...
The Prompt Assembler organelle is a core component of the AI Cognitive Fabric layer. It provides the essential prompt assembler functionality required for autonomous AI agent operations within the WebWaka platform.

### Primary Responsibilities
- Manage prompt assembler lifecycle and state transitions
...
| :--- | :--- | :--- |
| request | PROMPT_ASSEMBLERRequest | Incoming request payload with context |
| config | PROMPT_ASSEMBLERConfig | Configuration parameters |
| context | CognitiveContext | Shared cognitive fabric context |

### Outputs
| Output | Type | Description |
| :--- | :--- | :--- |
| result | PROMPT_ASSEMBLERResult | Processing result with metadata |
