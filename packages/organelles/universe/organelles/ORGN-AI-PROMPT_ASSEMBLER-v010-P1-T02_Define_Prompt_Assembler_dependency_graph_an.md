# [ORGN-AI-PROMPT_ASSEMBLER-v0.1.0-P1-T02] Define Prompt Assembler dependency graph and upstream/downstream bindings

**Structure:** `[ORGN-AI-PROMPT_ASSEMBLER-v0.1.0-P1-T02]`
**Layer:** Organelle
**Issue:** #936
...
The implementation of this issue satisfies all constitutional requirements for the `[ORGN-AI-PROMPT_ASSEMBLER-v0.1.0-P1-T02]` structure at the Organelle layer. All invariants defined in the issue body have been verified and encoded into the artefact record.
