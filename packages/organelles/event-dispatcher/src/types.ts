/**
 * EventDispatcher — Core Type Definitions
 * Organelle: ORG-EM-EVENT_DISPATCHER-v0.1.0
 */

export enum EventDispatcherState {
  IDLE = "IDLE",
...
export interface EventDispatcherCommand {
...
export interface EventDispatcherQuery {
  readonly type: string;
  readonly filters?: Record<string, unknown>;
}

export interface EventDispatcherQueryResult {
  readonly data: Record<string, unknown>;
  readonly timestamp: number;
}
...
export interface EventDispatcherError {
