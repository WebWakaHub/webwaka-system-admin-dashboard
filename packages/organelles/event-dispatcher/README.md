...
**Organelle ID:** ORG-EM-EVENT_DISPATCHER-v0.1.0
**Version:** 0.1.0
**Layer:** Organelle (smallest functional unit in WebWaka biological hierarchy)

## Overview

The EventDispatcher organelle provides a self-contained, deterministic functional unit
...
const orchestrator = new EventDispatcherOrchestrator({
  id: "my-event-dispatcher",
  name: "My EventDispatcher",
  maxConcurrency: 5,
  timeoutMs: 30000,
