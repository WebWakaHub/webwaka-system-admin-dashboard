# TrustAssertion Organelle

**Organelle ID:** ORG-ST-TRUST_ASSERTION-v0.1.0
**Version:** 0.1.0
**Layer:** Organelle (smallest functional unit in WebWaka biological hierarchy)

## Overview

The TrustAssertion organelle provides a self-contained, deterministic functional unit
...
```
┌─────────────────────────────────────────┐
│         TrustAssertionOrchestrator                 │
│                                         │
│  ┌──────────┐  ┌──────────────────────┐ │
│  │  State    │  │  TrustAssertionEntity          │ │
...
const orchestrator = new TrustAssertionOrchestrator({
  id: "my-trust-assertion",
  name: "My TrustAssertion",
  maxConcurrency: 5,
  timeoutMs: 30000,
