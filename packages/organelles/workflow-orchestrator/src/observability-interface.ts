/**
 * WorkflowOrchestrator — Observability Interface
 * Organelle: ORG-WO-WORKFLOW_ORCHESTRATOR-v0.1.0
 */

import { TelemetryData, OperationMetrics } from "./types";

export interface IWorkflowOrchestratorObservability {
...
export class DefaultWorkflowOrchestratorObservability implements IWorkflowOrchestratorObservability {
