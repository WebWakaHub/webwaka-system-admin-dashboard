# TelemetryCollector Organelle

**Organelle ID:** ORG-TS-TELEMETRY_COLLECTOR-v0.1.0
**Version:** 0.1.0
**Layer:** Organelle (smallest functional unit in WebWaka biological hierarchy)

## Overview

The TelemetryCollector organelle provides a self-contained, deterministic functional unit
...
```
┌─────────────────────────────────────────┐
│         TelemetryCollectorOrchestrator                 │
│                                         │
│  ┌──────────┐  ┌──────────────────────┐ │
│  │  State    │  │  TelemetryCollectorEntity          │ │
...
const orchestrator = new TelemetryCollectorOrchestrator({
  id: "my-telemetry-collector",
  name: "My TelemetryCollector",
  maxConcurrency: 5,
  timeoutMs: 30000,
