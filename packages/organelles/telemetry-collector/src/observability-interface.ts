/**
 * TelemetryCollector — Observability Interface
 * Organelle: ORG-TS-TELEMETRY_COLLECTOR-v0.1.0
 */

import { TelemetryData, OperationMetrics } from "./types";

export interface ITelemetryCollectorObservability {
...
export class DefaultTelemetryCollectorObservability implements ITelemetryCollectorObservability {
