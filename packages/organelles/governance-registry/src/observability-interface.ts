/**
 * GovernanceRegistry — Observability Interface
 * Organelle: ORG-RG-GOVERNANCE_REGISTRY-v0.1.0
 */

import { TelemetryData, OperationMetrics } from "./types";

export interface IGovernanceRegistryObservability {
...
export class DefaultGovernanceRegistryObservability implements IGovernanceRegistryObservability {
