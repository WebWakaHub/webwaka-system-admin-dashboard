/**
 * ValidationEngine — Core Type Definitions
 * Organelle: ORG-FV-VALIDATION_ENGINE-v0.1.0
 */

export enum ValidationEngineState {
  IDLE = "IDLE",
...
export interface ValidationEngineCommand {
...
export interface ValidationEngineQuery {
  readonly type: string;
  readonly filters?: Record<string, unknown>;
}

export interface ValidationEngineQueryResult {
  readonly data: Record<string, unknown>;
  readonly timestamp: number;
}

export interface ValidationEngineEvent {
  readonly type: string;
