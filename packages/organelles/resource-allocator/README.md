# ResourceAllocator Organelle

**Organelle ID:** ORG-RA-RESOURCE_ALLOCATOR-v0.1.0
**Version:** 0.1.0
**Layer:** Organelle (smallest functional unit in WebWaka biological hierarchy)

## Overview

The ResourceAllocator organelle provides a self-contained, deterministic functional unit
...
```
┌─────────────────────────────────────────┐
│         ResourceAllocatorOrchestrator                 │
│                                         │
│  ┌──────────┐  ┌──────────────────────┐ │
│  │  State    │  │  ResourceAllocatorEntity          │ │
...
const orchestrator = new ResourceAllocatorOrchestrator({
  id: "my-resource-allocator",
  name: "My ResourceAllocator",
  maxConcurrency: 5,
  timeoutMs: 30000,
