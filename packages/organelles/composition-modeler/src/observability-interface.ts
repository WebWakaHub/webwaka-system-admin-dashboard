/**
 * CompositionModeler — Observability Interface
 * Organelle: ORG-CM-COMPOSITION_MODELER-v0.1.0
 */

import { TelemetryData, OperationMetrics } from "./types";

export interface ICompositionModelerObservability {
...
export class DefaultCompositionModelerObservability implements ICompositionModelerObservability {
