# ValidationExecutor — Deployment Guide
...
```bash
npm install @webwaka/cell-validate-exec
```

## Configuration

```typescript
const config: ValidationExecutorConfig = {
  maxRetries: 3,
  timeoutMs: 30000,       // Nigeria-first: 30s
  offlineStorageKey: 'cel_validateexec_queue',
