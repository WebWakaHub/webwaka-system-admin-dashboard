...
| `VALIDATING` | Input is being validated by HealthChecker | → PROCESSING, → ERROR |
| `PROCESSING` | Core logic executing via AlertManager and DiagnosticReporter | → COMPLETING, → ERROR |
