# Aggregator — Structural Invariants
...
|:---|:----------|:------------|
| INV-01 | Cell MUST be composed of organelles from Data & Persistence category only | Static analysis at build time |
...
- `CELL_CATEGORY_UNIVERSE.md` — Single category assignment (Data & Persistence)
