# StreamingCell — State Machine Design
...
| `VALIDATING` | Input is being validated by StreamManager | → PROCESSING, → ERROR |
| `PROCESSING` | Core logic executing via ChunkTransformer and StreamDelivery | → COMPLETING, → ERROR |
