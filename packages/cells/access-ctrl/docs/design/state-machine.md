# AccessController — State Machine Design
...
| `VALIDATING` | Input is being validated by AccessEvaluator | → PROCESSING, → ERROR |
| `PROCESSING` | Core logic executing via PolicyEnforcer and AuditLogger | → COMPLETING, → ERROR |
