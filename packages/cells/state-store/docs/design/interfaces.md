...
export interface IStateStore {
  execute(command: StateStoreCommand, context: ExecutionContext): Promise<StateStoreResult>;
  executeOffline(command: StateStoreCommand, context: ExecutionContext): Promise<OfflineReceipt>;
