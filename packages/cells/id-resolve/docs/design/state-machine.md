# IdentityResolver — State Machine Design
...
| `VALIDATING` | Input is being validated by Authorizer | → PROCESSING, → ERROR |
| `PROCESSING` | Core logic executing via IdentityMapper and TokenManager | → COMPLETING, → ERROR |
