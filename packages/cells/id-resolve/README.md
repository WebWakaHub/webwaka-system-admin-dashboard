...
| Organelle | Role |
|:----------|:-----|
| Authenticator | Primary intake and initialization |
| Authorizer | Validation and constraint enforcement |
| IdentityMapper | Routing and orchestration logic |
| TokenManager | Execution and output delivery |

## Quick Start

```typescript
import { IdentityResolver, IdentityResolverOrchestrator } from '@webwaka/cell-id-resolve';

// Initialize via orchestrator
const orchestrator = new IdentityResolverOrchestrator({
