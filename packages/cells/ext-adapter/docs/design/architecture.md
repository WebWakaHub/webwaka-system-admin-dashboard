# ExternalAdapter — Architecture Design
...
│                  ExternalAdapter                        │
│  ┌──────────┐  ┌──────────┐  ┌──────────┐  │
│  │ ProtocolAd │→│ DataTransf │→│ RequestPro │  │
│  └──────────┘  └──────────┘  └──────────┘  │
│       ↑              │              ↓       │
│  ┌──────────┐  ┌──────────┐  ┌──────────┐  │
│  │ OfflineQ  │  │ AuditLog │  │ Integratio │  │
│  └──────────┘  └──────────┘  └──────────┘  │
└─────────────────────────────────────────────┘
```
...
```typescript
constructor(
  private readonly protocolAdapter: IProtocolAdapter,
  private readonly dataTransformer: IDataTransformer,
  private readonly requestProxy: IRequestProxy,
  private readonly integrationBridge: IIntegrationBridge,
