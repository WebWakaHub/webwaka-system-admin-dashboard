...
| Organelle | Role |
|:----------|:-----|
| ProtocolAdapter | Primary intake and initialization |
| DataTransformer | Validation and constraint enforcement |
| RequestProxy | Routing and orchestration logic |
| IntegrationBridge | Execution and output delivery |

## Quick Start

```typescript
import { ExternalAdapter, ExternalAdapterOrchestrator } from '@webwaka/cell-ext-adapter';

// Initialize via orchestrator
const orchestrator = new ExternalAdapterOrchestrator({
