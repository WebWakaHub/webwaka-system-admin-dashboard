/**
 * ExternalAdapterOrchestrator — Orchestrator Tests
 * Cell: CEL-EXTADAPTER-v0.1.0
 */

import { ExternalAdapterOrchestrator } from '../src/ext-adapter-orchestrator';

describe('ExternalAdapterOrchestrator', () => {
  let orchestrator: ExternalAdapterOrchestrator;

  beforeEach(() => {
    orchestrator = new ExternalAdapterOrchestrator({
      timeoutMs: 5000,
    });
  });
