# CommandProcessor — State Machine Design
...
| `VALIDATING` | Input is being validated by CommandValidator | → PROCESSING, → ERROR |
| `PROCESSING` | Core logic executing via CommandRouter and CommandExecutor | → COMPLETING, → ERROR |
