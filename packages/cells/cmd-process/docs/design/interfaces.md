# CommandProcessor — Interface Design
...
export interface ICommandProcessor {
  execute(command: CommandProcessorCommand, context: ExecutionContext): Promise<CommandProcessorResult>;
  executeOffline(command: CommandProcessorCommand, context: ExecutionContext): Promise<OfflineReceipt>;
