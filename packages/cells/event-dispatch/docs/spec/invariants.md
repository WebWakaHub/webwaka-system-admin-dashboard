# EventDispatcher — Structural Invariants
...
|:---|:----------|:------------|
| INV-01 | Cell MUST be composed of organelles from Eventing & State category only | Static analysis at build time |
...
- `CELL_CATEGORY_UNIVERSE.md` — Single category assignment (Eventing & State)
