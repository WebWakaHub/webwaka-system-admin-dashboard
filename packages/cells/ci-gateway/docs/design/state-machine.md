# CIGateway — State Machine Design
...
| `VALIDATING` | Input is being validated by MessageValidator | → PROCESSING, → ERROR |
| `PROCESSING` | Core logic executing via ProtocolNormalizer and InteractionRouter | → COMPLETING, → ERROR |
