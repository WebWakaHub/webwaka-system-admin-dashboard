...
| Organelle | Role |
|:----------|:-----|
| ChannelReceiver | Primary intake and initialization |
| MessageValidator | Validation and constraint enforcement |
| ProtocolNormalizer | Routing and orchestration logic |
| InteractionRouter | Execution and output delivery |

## Quick Start

```typescript
import { CIGateway, CIGatewayOrchestrator } from '@webwaka/cell-ci-gateway';

// Initialize via orchestrator
const orchestrator = new CIGatewayOrchestrator({
