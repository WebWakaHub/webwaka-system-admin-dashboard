...
The ShipmentTracking Organ encapsulates the business capability domain for transportation and shipping operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive shipment tracking functionality with full offline-first support.
...
```typescript
import { ShipmentTrackingOrgan } from '@webwaka/organ-trn-shipment-tracking';
