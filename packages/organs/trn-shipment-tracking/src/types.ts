/**
 * ShipmentTracking Organ — Domain Types
...
// Domain Command
export interface ShipmentTrackingCommand {
  id: string;
  type: string;
...
export interface ShipmentTrackingEvent {
  ...
  payload: Record<string, unknown>;
  timestamp: number;
  organId: 'ORGX-TRN-SHIPMENT_TRACKING';
  version: number;
  causationId: string;
}
...
export interface ShipmentTrackingAIInference {
  provider: string;
  model: string;
...
// Organ Health
export interface ShipmentTrackingHealth {
  organId: 'ORGX-TRN-SHIPMENT_TRACKING';
