# ShipmentTracking Organ — Tissue Integration Patterns
## Organ ID: ORGX-TRN-SHIPMENT_TRACKING

### Integration Strategy
Tissues within the ShipmentTracking organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
