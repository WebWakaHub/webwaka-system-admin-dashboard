# KeyManagement Organ — Tissue Integration Patterns
## Organ ID: ORGX-SEC-KEY_MANAGEMENT

### Integration Strategy
Tissues within the KeyManagement organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
