...
The KeyManagement Organ encapsulates the business capability domain for security and compliance operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive key management functionality with full offline-first support.
...
```typescript
import { KeyManagementOrgan } from '@webwaka/organ-sec-key-management';
