...
The PublicRecords Organ encapsulates the business capability domain for government and civic services operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive public records functionality with full offline-first support.
...
```typescript
import { PublicRecordsOrgan } from '@webwaka/organ-gov-public-records';
