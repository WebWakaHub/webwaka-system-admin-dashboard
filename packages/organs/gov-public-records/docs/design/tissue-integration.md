# PublicRecords Organ — Tissue Integration Patterns
## Organ ID: ORGX-GOV-PUBLIC_RECORDS

### Integration Strategy
Tissues within the PublicRecords organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
