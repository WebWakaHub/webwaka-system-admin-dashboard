...
The ApiGateway Organ encapsulates the business capability domain for external integration and api operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive api gateway functionality with full offline-first support.
...
```typescript
import { ApiGatewayOrgan } from '@webwaka/organ-ext-api-gateway';
