# ApiGateway Organ — Tissue Integration Patterns
## Organ ID: ORGX-EXT-API_GATEWAY

### Integration Strategy
Tissues within the ApiGateway organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
