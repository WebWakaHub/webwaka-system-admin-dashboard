# RelationshipManagement Organ — Tissue Integration Patterns
## Organ ID: ORGX-SOC-RELATIONSHIP_MANAGEMENT

### Integration Strategy
Tissues within the RelationshipManagement organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
