# ClinicalWorkflow Organ — Architecture Design
## Organ ID: ORGX-HLT-CLINICAL_WORKFLOW

### Architecture Overview
The ClinicalWorkflow organ follows a hexagonal architecture pattern with clear port/adapter boundaries. All internal tissue coordination is managed through a central OrganCoordinator.
