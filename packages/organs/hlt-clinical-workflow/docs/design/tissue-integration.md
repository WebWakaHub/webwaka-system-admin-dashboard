# ClinicalWorkflow Organ — Tissue Integration Patterns
## Organ ID: ORGX-HLT-CLINICAL_WORKFLOW

### Integration Strategy
Tissues within the ClinicalWorkflow organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
