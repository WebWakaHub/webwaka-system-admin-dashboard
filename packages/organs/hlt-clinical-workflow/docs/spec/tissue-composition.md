# ClinicalWorkflow Organ — Tissue Composition Requirements
## Organ ID: ORGX-HLT-CLINICAL_WORKFLOW

### Constituent Tissues
The ClinicalWorkflow organ is composed of the following tissue types:
1. **Command Coordination Tissue** — Orchestrates clinical workflow commands
2. **State Store Tissue** — Manages ClinicalWorkflow domain state with offline persistence
3. **Event Mesh Tissue** — Handles domain events within clinical workflow boundary
4. **Validation Tissue** — Enforces ClinicalWorkflow business rules

### Composition Rules
- All tissues MUST operate within the ClinicalWorkflow domain boundary
