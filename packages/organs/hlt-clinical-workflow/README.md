...
The ClinicalWorkflow Organ encapsulates the business capability domain for healthcare and clinical operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive clinical workflow functionality with full offline-first support.
...
```typescript
import { ClinicalWorkflowOrgan } from '@webwaka/organ-hlt-clinical-workflow';
