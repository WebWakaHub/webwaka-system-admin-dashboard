/**
 * ResourceScheduling Organ — Domain Types
...
// Domain Command
export interface ResourceSchedulingCommand {
  id: string;
  type: string;
...
// Domain Event
export interface ResourceSchedulingEvent {
  id: string;
  type: string;
  payload: Record<string, unknown>;
  timestamp: number;
  organId: 'ORGX-RES-RESOURCE_SCHEDULING';
  version: number;
  causationId: string;
}

// Domain Query
export interface ResourceSchedulingQuery {
  type: string;
...
export interface ResourceSchedulingAIInference {
  provider: string;
  model: string;
...
// Organ Health
export interface ResourceSchedulingHealth {
  organId: 'ORGX-RES-RESOURCE_SCHEDULING';
