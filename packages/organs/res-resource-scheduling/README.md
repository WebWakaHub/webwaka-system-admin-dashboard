...
The ResourceScheduling Organ encapsulates the business capability domain for resource and asset management operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive resource scheduling functionality with full offline-first support.
...
```typescript
import { ResourceSchedulingOrgan } from '@webwaka/organ-res-resource-scheduling';
