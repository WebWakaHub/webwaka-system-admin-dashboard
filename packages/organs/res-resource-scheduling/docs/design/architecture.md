# ResourceScheduling Organ — Architecture Design
## Organ ID: ORGX-RES-RESOURCE_SCHEDULING

### Architecture Overview
The ResourceScheduling organ follows a hexagonal architecture pattern with clear port/adapter boundaries. All internal tissue coordination is managed through a central OrganCoordinator.
