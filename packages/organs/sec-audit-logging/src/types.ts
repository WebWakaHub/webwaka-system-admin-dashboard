/**
 * AuditLogging Organ — Domain Types
...
// Domain Command
export interface AuditLoggingCommand {
  id: string;
  type: string;
...
// Domain Event
export interface AuditLoggingEvent {
  id: string;
  type: string;
  payload: Record<string, unknown>;
  timestamp: number;
  organId: 'ORGX-SEC-AUDIT_LOGGING';
  version: number;
  causationId: string;
}

// Domain Query
export interface AuditLoggingQuery {
  type: string;
...
// Domain State
export interface AuditLoggingState {
  version: number;
  lastUpdated: number;
...
export interface AuditLoggingAIInference {
  provider: string;
  model: string;
...
// Organ Health
export interface AuditLoggingHealth {
  organId: 'ORGX-SEC-AUDIT_LOGGING';
