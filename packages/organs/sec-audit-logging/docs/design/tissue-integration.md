# AuditLogging Organ — Tissue Integration Patterns
## Organ ID: ORGX-SEC-AUDIT_LOGGING

### Integration Strategy
Tissues within the AuditLogging organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
