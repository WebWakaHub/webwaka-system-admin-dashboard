# RegulatoryCompliance Organ — Tissue Integration Patterns
## Organ ID: ORGX-GOV-REGULATORY_COMPLIANCE

### Integration Strategy
Tissues within the RegulatoryCompliance organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
