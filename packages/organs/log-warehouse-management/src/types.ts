/**
 * WarehouseManagement Organ — Domain Types
...
// Domain Command
export interface WarehouseManagementCommand {
  id: string;
  type: string;
...
// Domain Event
export interface WarehouseManagementEvent {
  id: string;
  type: string;
  payload: Record<string, unknown>;
  timestamp: number;
  organId: 'ORGX-LOG-WAREHOUSE_MANAGEMENT';
  version: number;
  causationId: string;
}

// Domain Query
export interface WarehouseManagementQuery {
  type: string;
...
export interface WarehouseManagementAIInference {
  provider: string;
  model: string;
...
// Organ Health
export interface WarehouseManagementHealth {
  organId: 'ORGX-LOG-WAREHOUSE_MANAGEMENT';
