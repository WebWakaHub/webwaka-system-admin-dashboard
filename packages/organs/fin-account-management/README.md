...
The AccountManagement Organ encapsulates the business capability domain for financial services and ledger operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive account management functionality with full offline-first support.
...
```typescript
import { AccountManagementOrgan } from '@webwaka/organ-fin-account-management';
