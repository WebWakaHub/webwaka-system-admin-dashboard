# AccountManagement Organ — Tissue Integration Patterns
## Organ ID: ORGX-FIN-ACCOUNT_MANAGEMENT

### Integration Strategy
Tissues within the AccountManagement organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
