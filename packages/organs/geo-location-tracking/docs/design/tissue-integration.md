# LocationTracking Organ — Tissue Integration Patterns
## Organ ID: ORGX-GEO-LOCATION_TRACKING

### Integration Strategy
Tissues within the LocationTracking organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
