...
The LocationTracking Organ encapsulates the business capability domain for geospatial and location services operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive location tracking functionality with full offline-first support.
...
```typescript
import { LocationTrackingOrgan } from '@webwaka/organ-geo-location-tracking';
