# ProductCatalog Organ — Tissue Integration Patterns
## Organ ID: ORGX-COM-PRODUCT_CATALOG

### Integration Strategy
Tissues within the ProductCatalog organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
