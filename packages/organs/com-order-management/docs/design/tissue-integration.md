# OrderManagement Organ — Tissue Integration Patterns
## Organ ID: ORGX-COM-ORDER_MANAGEMENT

### Integration Strategy
Tissues within the OrderManagement organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
