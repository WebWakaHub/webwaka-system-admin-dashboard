# Authorization Organ — Tissue Integration Patterns
## Organ ID: ORGX-IDA-AUTHORIZATION

### Integration Strategy
Tissues within the Authorization organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
