...
The Authorization Organ encapsulates the business capability domain for identity and access management operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive authorization functionality with full offline-first support.
...
```typescript
import { AuthorizationOrgan } from '@webwaka/organ-ida-authorization';
