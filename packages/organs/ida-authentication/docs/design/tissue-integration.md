# Authentication Organ — Tissue Integration Patterns
## Organ ID: ORGX-IDA-AUTHENTICATION

### Integration Strategy
Tissues within the Authentication organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
