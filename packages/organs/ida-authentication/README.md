...
The Authentication Organ encapsulates the business capability domain for identity and access management operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive authentication functionality with full offline-first support.
...
```typescript
import { AuthenticationOrgan } from '@webwaka/organ-ida-authentication';
