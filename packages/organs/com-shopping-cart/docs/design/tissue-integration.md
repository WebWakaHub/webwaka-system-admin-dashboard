# ShoppingCart Organ — Tissue Integration Patterns
## Organ ID: ORGX-COM-SHOPPING_CART

### Integration Strategy
Tissues within the ShoppingCart organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
