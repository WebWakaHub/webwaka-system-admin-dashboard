...
The PatientManagement Organ encapsulates the business capability domain for healthcare and clinical operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive patient management functionality with full offline-first support.
...
```typescript
import { PatientManagementOrgan } from '@webwaka/organ-hlt-patient-management';
