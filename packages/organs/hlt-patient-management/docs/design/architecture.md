# PatientManagement Organ — Architecture Design
## Organ ID: ORGX-HLT-PATIENT_MANAGEMENT

### Architecture Overview
The PatientManagement organ follows a hexagonal architecture pattern with clear port/adapter boundaries. All internal tissue coordination is managed through a central OrganCoordinator.
