# PatientManagement Organ — Tissue Integration Patterns
## Organ ID: ORGX-HLT-PATIENT_MANAGEMENT

### Integration Strategy
Tissues within the PatientManagement organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
