...
// Domain Command
export interface GeocodingCommand {
  id: string;
  type: string;
...
export interface GeocodingAIInference {
  provider: string;
  model: string;
...
// Organ Health
export interface GeocodingHealth {
  organId: 'ORGX-GEO-GEOCODING';
