# Geocoding Organ — Tissue Integration Patterns
## Organ ID: ORGX-GEO-GEOCODING

### Integration Strategy
Tissues within the Geocoding organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
