...
The Geocoding Organ encapsulates the business capability domain for geospatial and location services operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive geocoding functionality with full offline-first support.
...
```typescript
import { GeocodingOrgan } from '@webwaka/organ-geo-geocoding';
