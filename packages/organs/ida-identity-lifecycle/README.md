...
The IdentityLifecycle Organ encapsulates the business capability domain for identity and access management operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive identity lifecycle functionality with full offline-first support.
...
```typescript
import { IdentityLifecycleOrgan } from '@webwaka/organ-ida-identity-lifecycle';
