# IdentityLifecycle Organ — Tissue Integration Patterns
## Organ ID: ORGX-IDA-IDENTITY_LIFECYCLE

### Integration Strategy
Tissues within the IdentityLifecycle organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
