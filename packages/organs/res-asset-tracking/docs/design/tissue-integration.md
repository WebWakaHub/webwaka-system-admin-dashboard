# AssetTracking Organ — Tissue Integration Patterns
## Organ ID: ORGX-RES-ASSET_TRACKING

### Integration Strategy
Tissues within the AssetTracking organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
