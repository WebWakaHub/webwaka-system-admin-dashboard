...
The AssetTracking Organ encapsulates the business capability domain for resource and asset management operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive asset tracking functionality with full offline-first support.
...
```typescript
import { AssetTrackingOrgan } from '@webwaka/organ-res-asset-tracking';
