# LearningProgress Organ — Tissue Integration Patterns
## Organ ID: ORGX-EDU-LEARNING_PROGRESS

### Integration Strategy
Tissues within the LearningProgress organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
