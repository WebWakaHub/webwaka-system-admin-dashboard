# OrderFulfillment Organ — Tissue Integration Patterns
## Organ ID: ORGX-LOG-ORDER_FULFILLMENT

### Integration Strategy
Tissues within the OrderFulfillment organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
