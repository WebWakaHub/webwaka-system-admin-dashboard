/**
 * InteractionEngine Organ — Domain Types
...
// Domain Command
export interface InteractionEngineCommand {
  id: string;
  type: string;
...
// Domain Event
export interface InteractionEngineEvent {
  id: string;
  type: string;
  payload: Record<string, unknown>;
  timestamp: number;
  organId: 'ORGX-SOC-INTERACTION_ENGINE';
  version: number;
  causationId: string;
}

// Domain Query
export interface InteractionEngineQuery {
  type: string;
...
export interface InteractionEngineAIInference {
  provider: string;
  model: string;
...
// Organ Health
export interface InteractionEngineHealth {
  organId: 'ORGX-SOC-INTERACTION_ENGINE';
