# InteractionEngine Organ — Tissue Integration Patterns
## Organ ID: ORGX-SOC-INTERACTION_ENGINE

### Integration Strategy
Tissues within the InteractionEngine organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
