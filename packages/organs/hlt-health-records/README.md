...
The HealthRecords Organ encapsulates the business capability domain for healthcare and clinical operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive health records functionality with full offline-first support.
...
```typescript
import { HealthRecordsOrgan } from '@webwaka/organ-hlt-health-records';
