# HealthRecords Organ — Tissue Integration Patterns
## Organ ID: ORGX-HLT-HEALTH_RECORDS

### Integration Strategy
Tissues within the HealthRecords organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
