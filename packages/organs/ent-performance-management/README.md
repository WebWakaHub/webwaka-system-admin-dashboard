...
The PerformanceManagement Organ encapsulates the business capability domain for enterprise management operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive performance management functionality with full offline-first support.
...
```typescript
import { PerformanceManagementOrgan } from '@webwaka/organ-ent-performance-management';
