# ThreatDetection Organ — Tissue Integration Patterns
## Organ ID: ORGX-SEC-THREAT_DETECTION

### Integration Strategy
Tissues within the ThreatDetection organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
