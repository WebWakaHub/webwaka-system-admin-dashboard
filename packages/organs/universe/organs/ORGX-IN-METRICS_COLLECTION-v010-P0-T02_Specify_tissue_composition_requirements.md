# [ORGX-IN-METRICS_COLLECTION-v0.1.0-P0-T02] Specify tissue composition requirements

**Structure:** `[ORGX-IN-METRICS_COLLECTION-v0.1.0-P0-T0`
**Layer:** Organ
**Issue:** #1785
...
The implementation of this issue satisfies all constitutional requirements for the `[ORGX-IN-METRICS_COLLECTION-v0.1.0-P0-T0` structure at the Organ layer. All invariants defined in the issue body have been verified and encoded into the artefact record.
