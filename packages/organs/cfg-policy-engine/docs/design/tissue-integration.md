# PolicyEngine Organ — Tissue Integration Patterns
## Organ ID: ORGX-CFG-POLICY_ENGINE

### Integration Strategy
Tissues within the PolicyEngine organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
