...
The Mapping Organ encapsulates the business capability domain for geospatial and location services operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive mapping functionality with full offline-first support.
...
```typescript
import { MappingOrgan } from '@webwaka/organ-geo-mapping';
