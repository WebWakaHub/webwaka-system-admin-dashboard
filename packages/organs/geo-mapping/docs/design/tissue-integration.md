# Mapping Organ — Tissue Integration Patterns
## Organ ID: ORGX-GEO-MAPPING

### Integration Strategy
Tissues within the Mapping organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
