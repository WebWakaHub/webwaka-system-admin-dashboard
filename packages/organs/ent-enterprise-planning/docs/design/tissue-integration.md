# EnterprisePlanning Organ — Tissue Integration Patterns
## Organ ID: ORGX-ENT-ENTERPRISE_PLANNING

### Integration Strategy
Tissues within the EnterprisePlanning organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
