...
The CourseManagement Organ encapsulates the business capability domain for education and learning operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive course management functionality with full offline-first support.
...
```typescript
import { CourseManagementOrgan } from '@webwaka/organ-edu-course-management';
