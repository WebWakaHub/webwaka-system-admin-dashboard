# CourseManagement Organ — Architecture Design
## Organ ID: ORGX-EDU-COURSE_MANAGEMENT

### Architecture Overview
The CourseManagement organ follows a hexagonal architecture pattern with clear port/adapter boundaries. All internal tissue coordination is managed through a central OrganCoordinator.
