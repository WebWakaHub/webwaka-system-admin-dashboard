# CourseManagement Organ — Tissue Integration Patterns
## Organ ID: ORGX-EDU-COURSE_MANAGEMENT

### Integration Strategy
Tissues within the CourseManagement organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
