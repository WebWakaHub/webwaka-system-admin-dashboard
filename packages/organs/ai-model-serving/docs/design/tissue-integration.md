# ModelServing Organ — Tissue Integration Patterns
## Organ ID: ORGX-AI-MODEL_SERVING

### Integration Strategy
Tissues within the ModelServing organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
