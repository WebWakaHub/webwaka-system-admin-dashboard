# MetricsCollection Organ — Tissue Integration Patterns
## Organ ID: ORGX-IN-METRICS_COLLECTION

### Integration Strategy
Tissues within the MetricsCollection organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
