/**
 * PortfolioAnalysis Organ — Domain Types
...
// Domain Command
export interface PortfolioAnalysisCommand {
  id: string;
  type: string;
...
// Domain Event
export interface PortfolioAnalysisEvent {
  id: string;
  type: string;
  payload: Record<string, unknown>;
  timestamp: number;
  organId: 'ORGX-FIN-PORTFOLIO_ANALYSIS';
  version: number;
  causationId: string;
}

// Domain Query
export interface PortfolioAnalysisQuery {
  type: string;
...
export interface PortfolioAnalysisAIInference {
  provider: string;
  model: string;
...
// Organ Health
export interface PortfolioAnalysisHealth {
  organId: 'ORGX-FIN-PORTFOLIO_ANALYSIS';
