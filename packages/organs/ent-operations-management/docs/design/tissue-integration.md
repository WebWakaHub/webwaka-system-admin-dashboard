# OperationsManagement Organ — Tissue Integration Patterns
## Organ ID: ORGX-ENT-OPERATIONS_MANAGEMENT

### Integration Strategy
Tissues within the OperationsManagement organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
