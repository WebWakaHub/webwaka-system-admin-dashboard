# CustomerAccount Organ — Tissue Integration Patterns
## Organ ID: ORGX-COM-CUSTOMER_ACCOUNT

### Integration Strategy
Tissues within the CustomerAccount organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
