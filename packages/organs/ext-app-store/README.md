...
The AppStore Organ encapsulates the business capability domain for external integration and api operations within the WebWaka platform. It coordinates constituent tissues to deliver cohesive app store functionality with full offline-first support.
...
```typescript
import { AppStoreOrgan } from '@webwaka/organ-ext-app-store';
