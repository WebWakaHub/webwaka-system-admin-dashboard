/**
 * TrainingPipeline Organ — Domain Types
...
// Domain Command
export interface TrainingPipelineCommand {
  id: string;
  type: string;
...
// Domain Event
export interface TrainingPipelineEvent {
  id: string;
  type: string;
  payload: Record<string, unknown>;
  timestamp: number;
  organId: 'ORGX-AI-TRAINING_PIPELINE';
  version: number;
  causationId: string;
}

// Domain Query
export interface TrainingPipelineQuery {
  type: string;
...
export interface TrainingPipelineAIInference {
  provider: string;
  model: string;
...
// Organ Health
export interface TrainingPipelineHealth {
  organId: 'ORGX-AI-TRAINING_PIPELINE';
