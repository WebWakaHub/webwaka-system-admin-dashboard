# TrainingPipeline Organ — Tissue Integration Patterns
## Organ ID: ORGX-AI-TRAINING_PIPELINE

### Integration Strategy
Tissues within the TrainingPipeline organ communicate through a shared internal event bus. No tissue may directly invoke another tissue's methods.
