# Runtime Adapter: AI
**Structure Code:** RUNTIME-ADAPTER-AI-v0.1.0
**Version:** v0.1.0
**Layer:** Runtime Plane
...
## Overview
The AI Adapter binds AI inference ports to concrete AI model providers, enabling platform-wide AI capabilities through a unified interface.

## Execution Role
Binds AI inference ports to concrete model providers (OpenAI, Anthropic, Manus Forge, local models)
