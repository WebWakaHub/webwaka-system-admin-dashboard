# Runtime Adapter: EXTERNAL-SERVICE
**Structure Code:** RUNTIME-ADAPTER-EXTERNAL-SERVICE-v0.1.0
**Version:** v0.1.0
**Layer:** Runtime Plane
...
## Overview
The External Service Adapter binds external API ports to concrete third-party service integrations, enabling platform connectivity with external systems.

## Execution Role
Binds external API ports to concrete third-party services (payment gateways, SMS providers, maps)
