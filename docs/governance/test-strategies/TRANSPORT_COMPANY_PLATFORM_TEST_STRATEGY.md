# Transport Company Platform Test Strategy
...
This document outlines the testing strategy for the Transport Company Platform module. The goal is to ensure the platform is of high quality, reliable, and meets all functional and non-functional requirements.
...
- End-to-end testing of user flows for transport company users.
...
- **Framework:** Cypress
- **Approach:** End-to-end tests will be written to simulate user flows for transport company users. The tests will cover the main user journeys, such as creating a new route, adding a vehicle, and managing bookings.
