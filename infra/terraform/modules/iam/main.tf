# ============================================================================
# IAM Module — WebWaka Service Roles
# ============================================================================
...
# ── ECS Task Role ────────────────────────────────────────────────────────────
# Used by the application containers for service-to-service communication
...
resource "aws_iam_role_policy" "ecs_task_services" {
  name = "${var.project_name}-${var.environment}-ecs-service-access"
    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:sqs:${var.aws_region}:${var.account_id}:${var.project_name}-*"
      },
      {
        Effect = "Allow"
        Action = [
        ...
        Resource = "arn:aws:events:${var.aws_region}:${var.account_id}:event-bus/${var.project_name}-events"
      },
      {
        Effect = "Allow"
        Action = [
